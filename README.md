...
Global mute/unmute hotkey for Google Meet. Works from any tab without switching to the meeting window. Supports multiple simultaneous meetings and a fully customizable shortcut. Published on the Chrome Web Store.
...
Market monitoring tool. Define a topic, get a structured intelligence report aggregated from Reddit, Hacker News, and Google News. FastAPI backend on Railway, React frontend on Vercel, DeepSeek as the LLM.
