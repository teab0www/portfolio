...
- Semantic search across 3,300 forum threads summarized by LLM
...
Market intelligence aggregating Reddit, Hacker News, and Google News.
- Stack: Python FastAPI, React, DeepSeek, Railway + Vercel

**>> voice-finance-tracking**  
Personal expense tracker using voice input to Google Sheets.
